...
object CollegesResource : AdminResource<College, CollegeId> {
  ...
  override val fields =
    listOf(
      ...
      AdminField("netPriceQ1", "Net Price \$0-30k", FieldType.INT, editable = false, sensitive = false, inList = false),
      AdminField("netPriceQ2", "Net Price \$30-48k", FieldType.INT, editable = false, sensitive = false, inList = false),
      AdminField("netPriceQ3", "Net Price \$48-75k", FieldType.INT, editable = false, sensitive = false, inList = false),
      AdminField("netPriceQ4", "Net Price \$75-110k", FieldType.INT, editable = false, sensitive = false, inList = false),
      AdminField("netPriceQ5", "Net Price \$110k+", FieldType.INT, editable = false, sensitive = false, inList = false),
      AdminField("medianDebt", "Median Debt", FieldType.INT, editable = false, sensitive = false, inList = false),
  ...
  override fun cells(row: College): Map<String, String> =
    mapOf(
      ...
      "netPriceQ1" to (row.netPriceQ1?.toString() ?: ""),
      "netPriceQ2" to (row.netPriceQ2?.toString() ?: ""),
      "netPriceQ3" to (row.netPriceQ3?.toString() ?: ""),
      "netPriceQ4" to (row.netPriceQ4?.toString() ?: ""),
      "netPriceQ5" to (row.netPriceQ5?.toString() ?: ""),
      "medianDebt" to (row.medianDebt?.toString() ?: ""),
