...
2. In the chat, output your brutal critique as the Reviewer. You must list at
   ...
   database indexes, unhandled race conditions, vague test descriptions). For
   each problem, you MUST provide at least 2 distinct options for how to resolve
   it, and explicitly recommend one.
