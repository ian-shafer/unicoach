...
- Generic Primitives with Syntactic Sugar: Code must always be implemented as generic primitives.
- Primitive Extraction: Centralize generic interactions into broad parent abstractions.
